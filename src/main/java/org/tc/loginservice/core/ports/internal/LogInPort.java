...
import org.tc.loginservice.shared.exceptions.TCInsertFailedException;
import org.tc.loginservice.shared.exceptions.TCInvalidRequestDataException;

public interface LogInPort {
    TokenResponseDto logIn(LoginRequestDto loginRequestDto) throws TCEntityNotFoundException, TCInvalidRequestDataException, TCInsertFailedException, TCIUpdateFailedException;
}
